...
organ_dictionary = {
    ...
    "Tronco": "tronco|madera", 
    "Tallos": "tallo|cuello|base",
...
symptoms_dictionary = {
    ...
    "Decoloración / Amarilleamiento / Clorosis": "decoloración|amarill|clareamient|bronceado|platead|cloróti|ceniciento|mosaico|jaspeado", 
    "Marchitez / Decaimiento / Seca regresiva": "marchit|debilitamiento|decaimiento|muerte|seco|seca|regresiva|retraso|momifica|enanismo|atrofia", 
    "Melaza / Negrilla / Secreciones / Micelio": "melaza|negrilla|hollín|secreción|secrecion|micelio|polvo|ceniza|moho|yeso|mole",
    "Cicatrices / Grietas / Deformaciones / Tumores": "cicatrices|deform|raspaduras|corchoso|agrietadas|resquebrajarse|agrieta|enrollamiento|agalla|tumor|nódulo|nodulo|elefantiasis|rizado|abarquillado|abultamiento|verruga|filiform", 
    "Podredumbre / Pudrición": "podredumbre|pudrición|acuosa|blanda",
    "Perforaciones / Galerías / Roeduras (Planta)": "galería|galeria|perforaciones|agujero|serrín|roeduras|punteaduras|incisiones|orificios|seccionado|dañad|cribado",
    ...
    "Exudados (Líquidos oscuros en tronco/raíz)": "exudado|gomoso|goma",
